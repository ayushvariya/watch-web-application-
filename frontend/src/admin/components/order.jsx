    ...
    <div className="w-full space-y-6">
      ...
      <div className="mb-8">
        <div className="flex items-center gap-3 mb-2">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-bold gradient-text">Manage Orders</h1>
          ...
          <div className="overflow-x-auto -mx-6 px-6">
            <div className="inline-block min-w-full align-middle">
              ...
              <thead className="bg-gradient-to-r from-indigo-50 to-purple-50">
                <tr>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">#</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Order ID</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Customer</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Product</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Qty</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Size</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Address</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Actions</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Delivery</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Status</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Payment</th>
                  <th className="py-4 px-4 text-left text-xs font-bold text-gray-700 uppercase tracking-wider">Return</th>
                </tr>
              </thead>
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredOrders.map((order, index) => (
                  <tr key={order._id} className="hover:bg-indigo-50/50 transition-colors">
                    <td className="py-4 px-4 text-gray-900 font-semibold">{index + 1}</td>
          ...
          <div className="w-full max-w-md rounded-2xl bg-white shadow-2xl border border-gray-200">
            <div className="p-6 border-b border-gray-200 bg-gradient-to-r from-indigo-50 to-purple-50">
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900">Assign Delivery</h3>
            ...
            <div className="p-6 space-y-5">
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Delivery Partner Name</label>
                <input
              ...
              <div>
                <label className="block text-sm font-semibold text-gray-700 mb-2">Delivery Partner Phone</label>
                <input
